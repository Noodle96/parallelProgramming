/*
	Compile: 
	nvcc rgb_to_grayScale.cu -I /usr/local/include/opencv4/
	                         -L /usr/local/lib/  -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_imgcodecs -lcudart
							-o imgConv
	Run:
	./imgConv imagenOrigen.jpg imagenFinal.jpg
...
int main(int argc, char **argv) 
{
	...
	unsigned char *h_grey_image = nullptr, *d_grey_image; //host and device's grey data array pointers
